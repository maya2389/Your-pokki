...
const cuteReplies = [
  "I love you 💝",
  "এ বেডা তোগো GC এর C E O মিজান কই😌",
  "তোর বাড়ি কি উগান্ডা না এখানে হুম",
  "Bot না জানু,বল 😌",
  "বলো জানু 🌚",
  "তোর কি চোখে পড়ে না আমি মিজান বস এর সাথে ব্যাস্ত আসি😒",
  "𝙏𝙢𝙧 𝙣𝙖𝙣𝙞 𝙧 𝐨𝐢 𝐭𝐚  😑🥺",
  ...
  "bye", "naw message daw m.me/md mizanur rahman", "mb ney bye", "meww", "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
  "𝗜 𝗹𝗼𝘃𝗲 𝘆𝗼𝘂__😘😘", "𝗜 𝗵𝗮𝘁𝗲 𝘆𝗼𝘂__😏😏", "গোসল করে আসো যাও😑😩", "অ্যাসসলামু আলাইকুম", "কেমন আসো",
  "বলেন sir__😌", "বলেন ম্যাডাম__😌", "আমি অন্যের জিনিসের সাথে কথা বলি না__😏ওকে", "🙂🙂🙂", "এটায় দেখার বাকি ছিলো_🙂🙂🙂",
  ...
  "𝗕𝗼𝘁 𝗕𝗼𝘁 না করে আমার বস মিজানের এর লগে প্রেম করতে পারো😑?", "আমার সোনার বাংলা, তারপরে লাইন কি? 🙈", "🍺 এই নাও জুস খাও..!𝗕𝗼𝘁 বলতে বলতে হাপায় গেছো না 🥲",
  ...
  "amr JaNu lagbe,Tumi ki single aso?", "আমাকে না ডেকে একটু পড়তেও তো বসতে পারো 🥺🥺", "তোর বিয়ে হয় নি 𝗕𝗼𝘁 হইলো কিভাবে,,🙄", 
